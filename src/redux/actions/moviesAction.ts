...
// get random movies    
export const getAllRandomMovies = () => async (dispatch: any) => {
    try {
...
// get movie detail    
export const getMovieById = (id: string) => async (dispatch: any) => {
    try {
...
//delete movie action    
export const deleteMovieAction = ({ id }: { id: string, }) => async (dispatch: any, getstate: any) => {
    try {
...
export const deleteAllMovieAction = () => async (dispatch: any, getstate: any) => {
    try {
...
// add casts
export const addCastsAction = (cast: any) => async (dispatch: any, getstate: any) => {
...
// remove cast
export const removeCastAction = (id: string) => async (dispatch: any, getstate: any) => {
...
//update movie action    
export const updateMovieAction = (movie: any, id: string) => async (dispatch: any, getstate: any) => {
    try {

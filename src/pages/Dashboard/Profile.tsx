...
import { userUpdatedProfileData } from "../../types/userType";
...
const Profile = () => {
    ...
    const {
        ...
        setValue,
        formState: { errors}
    } = useForm<userUpdatedProfileData>({
        resolver: yupResolver(UpdateProfileValidation)
    })

    const onSubmit: SubmitHandler<userUpdatedProfileData> = (data: userUpdatedProfileData) => {
        console.log(data);
       //@ts-ignore

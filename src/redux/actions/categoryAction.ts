...
export const createCategoryAction = (category: string) => async (dispatch: any, getState: any) => {
    try {
...
export const updateCategoryAction = (id: string, category: string) => async (dispatch: any, getState: any) => {
    try {
...
export const deleteCategoryAction = (id: string) => async (dispatch: any, getState: any) => {
    try {

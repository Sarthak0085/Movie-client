...
//get all movies
export const getAllMoviesReducers = (state = { movies: [] }, action: { type: any; payload: any; }) => {
...
export const getTopRatedMoviesReducers = (state = { movies: [] }, action: { type: any; payload: any; }) => {
...
//get random movies
export const getRandomMoviesReducers = (state = { movies: [] }, action: { type: any; payload: any; }) => {
...
//get movie details
export const movieDetailsReducers = (state = { movie: {} }, action: { type: any; payload: any; }) => {
...
export const deleteAllMovieReducer = (state = {}, action: { type: any; payload: any; }) => {
...
//casts
export const castsReducer = (state = { casts: [] }, action: { type: any; payload: any; }) => {
    switch (action.type) {
        ...
        case moviesConstants.EDIT_CAST:
            return {
                casts: state.casts.map((cast: any) => cast.id === action.payload.id ? action.payload : cast)
            };
...
//create movie reducers
export const updateMovieReducer = (state = {}, action: { type: any; payload: any; }) => {
    switch (action.type) {

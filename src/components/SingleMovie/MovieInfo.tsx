...
const MovieInfo = ({ movie, setModalOpen, download, progress }: { movie: MovieProps, setModalOpen: (modalOpen: boolean) => void; download: ( videoUrl: string, name: string) => void; progress: number }) => {

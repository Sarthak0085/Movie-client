...
const CategoryModal = ({ modalOpen, setModalOpen, category }) => {
    ...
    const { isLoading, isError, isSuccess, message } = useSelector((state: any) => state.adminCreateCategory);
    const { isLoading:updateLoading, isError: updateError, isSuccess: updateSuccess, message: updateMessage } = useSelector((state: any) => state.adminUpdateCategory);

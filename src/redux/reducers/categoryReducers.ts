...
//get all categories
export const getAllCategoriesReducers = (state = { categories: [] }, action: { type: any; payload: any; }) => {
...
//create new category
export const createNewCategoryReducer = (state = {}, action: { type: any; payload: any; }) => {
...
//update category
export const updateCategoryReducer = (state = {}, action: { type: any; payload: any; }) => {
...
//update category
export const deleteCategoryReducer = (state = {}, action: { type: any; payload: any; }) => {

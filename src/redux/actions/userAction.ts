...
//login action
export const registerAction = (data: userRegisterData) => async (dispatch: any) => {
    try {
...
//login action
export const loginAction = (data: userLoginData) => async (dispatch: any) => {
    try {
...
export const updateProfileAction = (user: any) => async (dispatch: any, getState: any) => {
    try {
...
export const changeUserPasswordAction = (passwords: { oldPassword: string, newPassword: string }) => async (dispatch: any, getState: any) => {
    try {
...
export const getUserAllFavouritesMovieAction = () => async (dispatch: any, getState: any) => {
    try {
...
export const deleteUserAllFavouritesMovieAction = () => async (dispatch: any, getState: any) => {
    try {
...
export const getAllUsersAction = () => async (dispatch: any, getState: any) => {
    try {
...
export const deleteUserAction = (id: string) => async (dispatch: any, getState: any) => {
    try {
...
//like movie action
export const likeMovieAction = (movieId: string) => async (dispatch: any, getState: any) => {
    try {
